...
import { generateAutoResponse, checkUrgency } from '../../utils/autoResponder';
...
const TicketList = () => {
  ...
  const handleSendReply = async () => {
    ...
    try {
      // Check urgency before updating
      const urgencyCheck = checkUrgency(selectedTicket);
      const newStatus = urgencyCheck.isUrgent ? 'urgent' : 'in_progress';
      const newPriority = urgencyCheck.isUrgent ? 'urgent' : selectedTicket.priority;
      ...
      console.log('Sending email notification:', {
        ...
        message: replyText,
        urgency: urgencyCheck.isUrgent ? 'Urgent' : 'Normal',
  ...
  const handleResolveTicket = async () => {
    ...
    try {
      ...
      console.log('Sending resolution notification:', {
        to: selectedTicket.email,
